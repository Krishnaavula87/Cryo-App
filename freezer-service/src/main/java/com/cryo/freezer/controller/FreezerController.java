...
public class FreezerController {
    ...
    @GetMapping("/api/internal/full/{ownerUserId}")
    public ResponseEntity<List<FreezerStatusResponse>> getInternalFullStatus(
            @PathVariable("ownerUserId") String ownerUserId) {

        List<FreezerStatusResponse> result =
                freezerService.getFullStatusForUser(ownerUserId);
    ...
    @GetMapping("/{freezerId}/export-data")
    public ResponseEntity<?> getExportData(
        ...
        ExportResponseWrapper response =
                freezerService.getExportData(freezerId, from, to);
    ...
    public ResponseEntity<List<DeviceInfoDto>> getAllDevicesForExport() {

        List<DeviceInfoDto> devices =
                freezerService.getAllDevicesForExport();
    ...
    @GetMapping("/api/internal/export-data/{freezerId}")
    public ResponseEntity<?> getInternalExportData(
    ...
    @GetMapping("/api/internal/chart/{freezerId}")
    public ResponseEntity<ApiResponse<List<?>>> getInternalChart(
